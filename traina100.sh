for FOLD in 3 # 4
do 
    python training/pipeline/train_image_classifier.py --device 'cuda' --fold $FOLD --batchsize 32 --logdir 'logs/zoo' --augextra False  --label-smoothing 0.0 --config 'configs/512/effnetb5_lr5e4_binary.json'
